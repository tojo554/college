...
<div class="container">
    <div class="row">
        <div class="col col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
            <ul class="list-group">
                <li class="list-group-item"><b><h5> ABOUT DEPARTMENT </h5></b></li>
              
                <li class="list-group-item list-group-item-info">ACADEMIC CALENDAR</li>
                <li class="list-group-item list-group-item-info">ASSOCIATIONS</li>
                <li class="list-group-item list-group-item-info">STUDENT ACHIEVEMENT</li>
                <li class="list-group-item list-group-item-info">WORKSHOPS & EVENTS</li>
                <li class="list-group-item list-group-item-info">PLACEMNET</li>
                <li class="list-group-item list-group-item-info">SYLLABUS</li>
                <li class="list-group-item list-group-item-info">TIME TABLE</li>
                <li class="list-group-item list-group-item-info">DIARY OF EVENTS</li>
              </ul>
        </div>
