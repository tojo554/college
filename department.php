    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="https://news.gsu.edu/files/2019/05/computers-women.jpg" height="700" width="500" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="https://blogs.surrey.ac.uk/careers/wp-content/uploads/sites/63/2020/03/Physics2.jpg" height="700" width="500" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="https://pbs.twimg.com/media/Dg7QAy2WAAAXjxZ.jpg" height="700" width="500" class="d-block w-100" alt="...">
          </div>
        </div>
                       ...
                       <table class="table table-borderless">
                           <tr>
                               <td>
                                ...
                                <img src="https://lh3.googleusercontent.com/proxy/IW0Y8L73Fb-gViCBGj_0Yof8UiCUewUXEtubUCPnpIyvv9idQRFweP_8ok63Tc8fz1YWteDUO31MEhS6mlZmpoNZg-8ml_1b"class="card-img-top" alt="...">
                                        <div class="card-body">
                               ...
                               <td><div class="card" style="width: 18rem;">
                                        <img src="https://chitkara.edu.in/landing-pages/2020/mba/images/student-pic.png"  class="card-img-top" alt="...">
                                        <div class="card-body">
                               ...
                               <td><div class="card" style="width: 18rem;">
                                         <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSp2AJKyEbfaVAlOHsBB_bu62M3RAWZWceUOA&usqp=CAU" height="200" card-img-top" alt="...">
                                         <div class="card-body">
                                ...
                                <tr>
                                 <td>
                                   <div class="card" style="width: 18rem;">
                                <img src="https://www.ip-paris.fr/sites/default/files/styles/actualite_full/public/pages/images/2020-09/Physique.jpg?h=a1879aaa&itok=2JYHI0cI" class="card-img-top" alt="...">
                                <div class="card-body">
                               ...
                               <td>
                                <div class="card" style="width: 18rem;">
                                <img src="https://d2r2ijn7njrktv.cloudfront.net/IL/uploads/2018/06/Medical-Students_Representative.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
